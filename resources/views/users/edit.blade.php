...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal form-row-seperated"
              action="{{ URL::action('UsersController@update', $result->id) }}" method="Post" enctype="multipart/form-data">
                ...
                <div class="portlet">
                    ...
                    <div class="porlet-body-right col-xs-12 col-sm-3">
                        <img id="output" class="img-responsive"
                            <?php if(isset($result['avatar'])){ echo "src='/public/upload/images/"."$result[avatar]'";} ?>/>
                    </div>
        </form>
