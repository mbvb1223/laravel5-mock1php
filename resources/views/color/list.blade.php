    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.list_color'); ?>
                </div>
                <div class="actions">
                    <a href="{{ URL::action('ColorController@create') }}" class="btn default yellow-stripe">
            ...
            <div class="portlet-body">
                <table id="grid-data-api" class="table table-condensed table-hover table-striped">
                    <thead>
                    <tr>
                        <th data-column-id="color_name"><?php echo Lang::get('messages.color_name'); ?></th>
