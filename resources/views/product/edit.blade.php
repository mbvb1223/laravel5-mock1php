            ...
            <form class="form-horizontal form-row-seperated" action="{{ URL::action('ProductController@update') }}"
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.edit_product'); ?>
                        </div>
...
@section('js')
    <script src="<?php echo url("/"); ?>/../theme/assets/frontend/layout/scripts/jquery.number.js"
            type="text/javascript"></script>
    <script src="<?php echo url("/"); ?>/../theme/assets/frontend/layout/scripts/product.js"
            type="text/javascript"></script>
