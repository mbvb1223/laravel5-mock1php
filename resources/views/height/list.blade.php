    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.list_heights'); ?>
                </div>
                <div class="actions">
                    <a href="{{ URL::action('HeightController@create') }}" class="btn default yellow-stripe">
            ...
            <div class="portlet-body">
                <table id="grid-data-api" class="table table-condensed table-hover table-striped">
                    <thead>
                    <tr>
                        <th data-column-id="height_value"><?php echo Lang::get('messages.height_value'); ?></th>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $("#grid-data-api").bootgrid({
                ...
                url: "{{url('admin/height/getDataAjax')}}"
