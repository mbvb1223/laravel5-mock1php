    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.list_roles'); ?>
                </div>
                <div class="actions">
                    <a href="{{ URL::action('RolesController@create') }}" class="btn default yellow-stripe">
            ...
            <div class="portlet-body">
                <table id="grid-data-api" class="table table-condensed table-hover table-striped">
                    <thead>
                    <tr>
                        <th data-column-id="rolename"><?php echo Lang::get('messages.roles_rolename'); ?></th>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $("#grid-data-api").bootgrid({
                ...
                url: "{{url('admin/roles/getDataAjax')}}"
