            ...
            <div class="portlet">
                <div class="portlet-title">
                    ...
                    <div class="actions btn-set">
                        <a href="{{ URL::action('UsersController@index') }}" name="back" class="btn default"><i class="fa fa-angle-left"></i> <?php echo Lang::get('messages.list_users'); ?></a>
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="rolename" value="{{ old('rolename', $result['rolename'])}}" id="rolename" placeholder="<?php echo Lang::get('messages.roles_rolename'); ?>">
                        </div>
                    </div>
                </div>
