    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.list_size'); ?>
                </div>
                <div class="actions">
                    <a href="{{ URL::action('SizeController@create') }}" class="btn default yellow-stripe">
            ...
            <div class="portlet-body">
                <table id="grid-data-api" class="table table-condensed table-hover table-striped">
                    <thead>
                    <tr>
                        <th data-column-id="size_value"><?php echo Lang::get('messages.size_value'); ?></th>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $("#grid-data-api").bootgrid({
                ...
                url: "{{url('admin/size/getDataAjax')}}"
